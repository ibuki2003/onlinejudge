...
<form action="{{route('problem_edit', ['id' => $problem->id])}}" method="post" name="form" enctype="multipart/form-data" autocomplete="off">
    ...
    <div class="form-group">
        ...
        <input type="text" id="title-input" name="title" class="form-control{{ $errors->has('title') ? ' is-invalid' : '' }}"
            value="{{ old('title') == "" ? $problem->title : old('title') }}" required>
        @if ($errors->has('title'))
    ...
    <div class="form-group">
        ...
        <input type="number" id="difficulty-input" name="difficulty" class="form-control{{ $errors->has('difficulty') ? ' is-invalid' : '' }}"
            min="1" max="{{config('oj.difficulty_max')}}" value="{{ old('difficulty') == NULL ? $problem->difficulty : old('difficulty') }}" required>
    ...
    <div class="form-group">
        ...
        <input type="file" id="content-file" name="zip_content" class="form-control-file{{ $errors->has('zip_content') ? ' is-invalid' : ''}}">
    ...
    <div class="form-group">
        ...
        <input type="datetime-local" id="open-time" name="open" class="form-control{{ $errors->has('open') ? ' is-invalid' : ''}}"
            value="{{ old('open') == NULL ? $problem->open : old('open') }}">
