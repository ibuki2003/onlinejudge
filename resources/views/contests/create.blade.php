...
@section('title', __('name.contest.new'))
...
<div id="problems-controller">
    ...
    <div class="form-group">
        ...
        <textarea id="description-input" name="description" class="form-control"></textarea>
        <div class="invalid-feedback" id="description-error"></div>
    </div>
    <div class="form-group">
        <label for="start_time-input">{{__('ui.contest.start_time')}}</label>
        <input type="datetime-local" id="start_time-input" name="start_time" class="form-control">
        <div class="invalid-feedback" id="start_time-error"></div>
    </div>
    <div class="form-group">
        <label for="end_time-input">{{__('ui.contest.end_time')}}</label>
        <input type="datetime-local" id="end_time-input" name="end_time" class="form-control">
        <div class="invalid-feedback" id="end_time-error"></div>
    </div>
    <div class="form-group">
        <label for="penalty-input">{{__('ui.contest.penalty_in_munites')}}</label>
        <input type="number" min="0" max="100000" value="5" id="penalty-input" name="penalty" class="form-control">
